...
run_static_checks() {
    ...
    "${CC:-cc}" -std=c11 -Wall -Wextra -Werror -Imain \
        tests/test_time_track_model.c main/time_track_model.c \
        -o "${test_dir}/test_time_track_model"
    "${test_dir}/test_time_track_model"
    ...
    PYTHONDONTWRITEBYTECODE=1 python3 tests/test_time_track_font.py

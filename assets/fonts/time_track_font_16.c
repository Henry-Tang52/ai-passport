 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --size 16 --bpp 4 --format lvgl --no-compress --lv-font-name time_track_font_16 --lv-include lvgl.h --font /usr/share/fonts/truetype/dejavu/DejaVuSans.ttf --range 0x20-0x7E --font /usr/share/fonts/truetype/droid/DroidSansFallbackFull.ttf --symbols 用时记账实习投递生活面试学校运动未在记计中今日共昨天 --output /workspace/assets/fonts/time_track_font_16.c
 ******************************************************************************/
...
#ifndef TIME_TRACK_FONT_16
#define TIME_TRACK_FONT_16 1
#endif

#if TIME_TRACK_FONT_16
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x0, 0xf, 0x50, 0x5, 0xff, 0xff, 0xe0, 0x0,
    0x3, 0x3f, 0x73, 0x6, 0xd3, 0x37, 0xe0, 0x0,
    0xf, 0xff, 0xff, 0x8, 0xb0, 0x5, 0xe0, 0x0,
    0x0, 0xf, 0x50, 0xd, 0x80, 0x5, 0xf0, 0x0,
    0x0, 0xf, 0x50, 0xae, 0x10, 0x2, 0xff, 0xe0,
    0x0, 0xf, 0x67, 0x44, 0x22, 0x22, 0x34, 0x10,
    0x0, 0x3f, 0xfc, 0x7f, 0xff, 0xff, 0xfd, 0x0,
    0x2e, 0xff, 0x70, 0xb, 0x90, 0x0, 0xb9, 0x0,
    0x6, 0x1f, 0x50, 0x2, 0xf3, 0x3, 0xf2, 0x0,
    0x0, 0xf, 0x50, 0x0, 0x6e, 0x3d, 0x70, 0x0,
    0x0, 0xf, 0x50, 0x0, 0x1d, 0xfd, 0x10, 0x0,
    0x5, 0x4f, 0x41, 0x6b, 0xfb, 0x5c, 0xfb, 0x81,
    0xa, 0xfd, 0x13, 0xe9, 0x30, 0x0, 0x48, 0xb0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    ...
    /* U+9012 "递" */
    0x2, 0x10, 0x0, 0x1a, 0x0, 0xb, 0x50, 0x0,
    0xb, 0xe3, 0x0, 0x1d, 0x81, 0x7f, 0x31, 0x0,
    0x0, 0xae, 0x7, 0xff, 0xff, 0xff, 0xfe, 0x0,
    0x0, 0x2, 0x0, 0x0, 0xf, 0x40, 0x3e, 0x0,
    0x0, 0x0, 0x1, 0xcc, 0xcf, 0xdc, 0xde, 0x0,
    0x19, 0x98, 0x4, 0xe4, 0x4f, 0x74, 0x44, 0x0,
    0x2c, 0xdf, 0x6, 0xc0, 0xf, 0x40, 0x0, 0x0,
    0x0, 0x5f, 0x8, 0xff, 0xff, 0xff, 0xff, 0xc0,
    0x0, 0x5f, 0x0, 0x14, 0xff, 0x41, 0x19, 0xa0,
    0x0, 0x5f, 0x0, 0x6f, 0x5f, 0x40, 0xa, 0x80,
    0x0, 0x5f, 0x1c, 0xe5, 0xf, 0x44, 0x8e, 0x40,
    0x0, 0x5f, 0x27, 0x10, 0xf, 0x44, 0x86, 0x0,
    0x8, 0xfa, 0xfc, 0x87, 0x7b, 0x76, 0x66, 0x62,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 4434, .adv_w = 256, .box_w = 12, .box_h = 13, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 4512, .adv_w = 256, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4632, .adv_w = 256, .box_w = 14, .box_h = 15, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 4737, .adv_w = 256, .box_w = 15, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4850, .adv_w = 256, .box_w = 15, .box_h = 14, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 4955, .adv_w = 256, .box_w = 16, .box_h = 14, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5067, .adv_w = 256, .box_w = 16, .box_h = 14, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 5179, .adv_w = 256, .box_w = 15, .box_h = 15, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 5292, .adv_w = 256, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5412, .adv_w = 256, .box_w = 12, .box_h = 13, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 5490, .adv_w = 256, .box_w = 15, .box_h = 14, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 5595, .adv_w = 256, .box_w = 15, .box_h = 15, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 5708, .adv_w = 256, .box_w = 15, .box_h = 14, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 5813, .adv_w = 256, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5933, .adv_w = 256, .box_w = 16, .box_h = 14, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 6045, .adv_w = 256, .box_w = 16, .box_h = 14, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 6157, .adv_w = 256, .box_w = 15, .box_h = 14, .ofs_x = 0, .ofs_y = -2},
    ...
    {.bitmap_index = 6486, .adv_w = 256, .box_w = 16, .box_h = 14, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 6598, .adv_w = 256, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 6718, .adv_w = 256, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 6838, .adv_w = 256, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 6958, .adv_w = 256, .box_w = 16, .box_h = 13, .ofs_x = 0, .ofs_y = -1}
};
...
static const uint16_t unicode_list_1[] = {
    0x0, 0x33, 0x9d, 0x344, 0x47b, 0x8fb, 0xafc, 0xd39,
    0xd71, 0x1468, 0x17b8, 0x17c9, 0x17fb, 0x18fd, 0x19f4, 0x1f0e,
    0x26f2, 0x26fb, 0x3d74, 0x3d83, 0x3da8, 0x3ef9, 0x41a3, 0x41e5,
    0x4935
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t time_track_font_16 = {
#else
lv_font_t time_track_font_16 = {
#endif
